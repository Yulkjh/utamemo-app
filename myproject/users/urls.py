...
urlpatterns = [
    ...
    path('upgrade/parental-consent/', views.request_parental_consent, name='parental_consent'),
    path('parental-consent/confirm/<int:user_id>/<str:token>/', views.confirm_parental_consent, name='confirm_parental_consent'),
