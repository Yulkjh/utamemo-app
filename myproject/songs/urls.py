...
urlpatterns = [
    ...
    path('unite-cinema-minato/movies/now-showing/', views.TheaterNowShowingView.as_view(), name='unite_cinema_minato_now_showing'),
    path('unite-cinema-minato/movies/coming-soon/', views.TheaterComingSoonView.as_view(), name='unite_cinema_minato_coming_soon'),
    path('unite-cinema-minato/movies/advance-tickets/', views.TheaterAdvanceTicketsView.as_view(), name='unite_cinema_minato_advance_tickets'),
    path('unite-cinema-minato/api/schedule/', views.theater_schedule_api, name='unite_cinema_minato_schedule_api'),
    path('unite-cinema-minato/api/reservations/', views.theater_reservation_status_api, name='unite_cinema_minato_reservation_api'),
    path('unite-cinema-minato/survey/', views.TheaterSurveyView.as_view(), name='unite_cinema_minato_survey'),
    ...
    path('staff/monitor/refresh/', views.staff_monitor_refresh, name='staff_monitor_refresh'),
]