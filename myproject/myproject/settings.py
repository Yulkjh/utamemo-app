...
MIDDLEWARE = [
    ...
    'users.middleware.StaffReviewLockMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myproject.context_processors.user_usage_context',
            ],
        },
    },
]
...
ADMIN_NOTIFICATION_EMAIL = os.getenv('ADMIN_NOTIFICATION_EMAIL', 'hope47284@gmail.com')
